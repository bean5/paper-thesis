...
%Krstovski (2013)
to the Corpus of LDS General Conference talks. I will then compare performance to that of an \emph{TF-IDF} model using some of the metrics outlined by \citeyearpar{Ge:2010:BAE:1864708.1864761}
%Ge et al. (2010)
